...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def tickaa(self):
        ...
        data[self.comboBox.currentText()][self.lineEdit.text()] = self.lineEdit_2.text()
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(220, 115, 230, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "工具名称："))
        self.label_2.setText(_translate("MainWindow", "选择模块："))
        self.label_3.setText(_translate("MainWindow", "工具启动代码："))
